...
The dataset used for this analysis contains 180 observations and 10 variables in the main structured table (prof_2018_2019).These variables are Category, WHE Bottom, WHE Top, # Children, Average, # Below, % Below, # Meeting / Exceeding, % Meeting / Exceeding, and Time Period. In our analysis, we included Category, # Children, # Below, % Below, # Meeting / Exceeding, % Meeting / Exceeding, and Time Period, while WHE Bottom, WHE Top, and Average were not included as analytic outcomes and were used only as benchmarks/reference.

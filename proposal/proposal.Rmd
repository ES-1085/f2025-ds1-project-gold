...
Our dataset has 180 rows and 10 columns (prof_2018_2019): Category, WHE Bottom, WHE Top, # Children, Average, # Below, % Below, # Meeting/Exceeding, % Meeting/Exceeding, and Time Period. For analysis, we used Category, # Children, # Below, % Below, # Meeting/Exceeding, % Meeting/Exceeding, and Time Period. We did not analyze WHE Bottom, WHE Top, or Average, as we used them only as benchmarks.

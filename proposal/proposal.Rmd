...
For analysis, we used Category, # Children, # Below, % Below, # Meeting/Exceeding, % Meeting/Exceeding, and Time Period. We did not analyze WHE Bottom, WHE Top, or Average; we used them only as benchmarks.
